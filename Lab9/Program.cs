    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                { //display name and favorite color
                ...
                if (input.Equals("student", StringComparison.InvariantCultureIgnoreCase)) //seeing if the user enters "student" to learn aobut more students
                {
                    shouldContinue = true;
                }
                else if (input.Equals("add", StringComparison.InvariantCultureIgnoreCase)) //seeing if the user enters "add" to add a student and his info
                {
                    AddStudent();
                    shouldContinue = true;
                }
                ...
                {
                    Console.WriteLine("Goodbye!"); //ends program
                }
        ...
        static List<string> color = new List<string> { "Green", "Purple", "Orange", "Blue", "Yellow", "Red", "Navy Blue", "Lime Green", "Gray", "Black", "White", "Brick Red", "Olive", "Dark Violet", "Pale Green", "Gold", "Cyan", "Maroon", "Magenta"}; //the whole enchilada of student info

        static string GetUserInput(string inputName) //method
        {
            string input;
            ...
            do
            {
                isValidInput = true;//if input is valid it's true
            ...
            } while (!isValidInput);//if input is not valid do this again until it is valid
            return input;
        }
        static void AddStudent() //adding a student to the list
        {
            names.Add(GetUserInput("name"));
            hometown.Add(GetUserInput("hometown"));//the student is added to list by x.Add(GetUserInput("x"));
